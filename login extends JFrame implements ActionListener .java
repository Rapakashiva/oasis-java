...
class OnlineTestBegin extends JFrame implements ActionListener {
    ...
    void set() {
        ...
        if (current == 1) {
            l.setText("Que2: What is the default value of a local variable in Java?");
            jb[0].setText("null");
            jb[1].setText("No default value");
            jb[2].setText("Depends on the data type");
            jb[3].setText("0");
        }
        if (current == 2) {
        ...
        if (current == 3) {
            l.setText("Que4: Which of these keywords is used to define interfaces in Java.?");
...
[4:18 PM, 7/25/2024] Jithu Ds: import java.util.Scanner;
